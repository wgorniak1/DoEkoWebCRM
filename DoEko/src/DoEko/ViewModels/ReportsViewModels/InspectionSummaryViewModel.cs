...
namespace DoEko.ViewModels.ReportsViewModels
{
    ...
    {
        public InspectionSummaryViewModel()
        {
        }

        public InspectionSummaryViewModel(DoEkoContext _context)
        {
        ...
        {
            ProjectList = new SelectList(await _context.Projects.Where(p => p.ProjectId != 1).Select(p => new SelectListItem()
            {
